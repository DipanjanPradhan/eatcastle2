            ...
            return this.each(function() {
                ...
                function getButton(index, button, title) {
                    ...
                    return $('<li/>').append($('<a/>')
                                                    ...
                                                    .attr('alt', '').css({ width: 28, height: 25, marginTop: 0 })).hover(function() {
                                                        ...
                                                        var b = $(this);
                                                        if (settings.animate)
                                                            b.find('img').stop(false, true).animate({ height: 30, width: 30, marginTop: 0 }, 300);
                                                        ...
                                                        if (settings.animate)
                                                            $(this).find('img').stop(false, true).animate({ width: 28, height: 25, marginTop: 0 }, 300);
